...
if __name__ == "__main__":
    mock_signals = [
        Structure(dimension='data_integrity', name='dataset_shape', value={'rows': 10, 'cols': 5}, status='ok', meta=None),
        Structure(dimension='data_integrity', name='global_missing_ratio', value=0.04, status='ok', meta={'total_cells': 50}),
        Structure(dimension='data_integrity', name='column_missing_ratio', value={'per_column': {'age': 0.2, 'salary': 0.0, 'city': 0.0, 'score': 0.0, 'constant_col': 0.0}, 'worst_ratio': 0.2}, status='ok', meta={'num_columns': 5}),
        Structure(dimension='data_integrity', name='duplicated_ratio', value=0.3, status='ok', meta={'num_rows': 10}),
        Structure(dimension='data_integrity', name='constant_columns_ratio', value={'columns': ['constant_col'], 'ratio': 0.2}, status='ok', meta={'total_columns': 5}),
        Structure(dimension='data_integrity', name='hidden_missing_ratio', value={'ratios': {'city': 0.3, 'score': 0.0}, 'worst_ratio': 0.3}, status='ok', meta={'num_object_columns': 2}),
        Structure(dimension='data_integrity', name='mixed_type_columns_ratio', value={'columns': ['score'], 'ratio': 0.2}, status='ok', meta={'num_object_columns': 2}),
    ]
